...
export default function BadgerBackers() {
    ...
    function fetchUser() {
        fetch("https://cs571api.cs.wisc.edu/rest/s25/bonus/whoami", {
            headers: {
    ...
    function resetPurchases() {
        fetch("https://cs571api.cs.wisc.edu/rest/s25/bonus/backings", {
            method: "DELETE",
            headers: {
                "X-CS571-ID": CS571.getBadgerId()
            }
    ...
    function reloadBackingData() {
        fetch("https://cs571api.cs.wisc.edu/rest/s25/bonus/backees", {
            headers: {
                "X-CS571-ID": CS571.getBadgerId()
            }
        }
